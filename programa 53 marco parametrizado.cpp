...
#include <windows.h>
using namespace std;
void marco1(void);//enczabezados de funciones
void marco2(char c, int c1, int r1, int c2, int r2);
void gotoxy(int x, int y);
int y=123;//variable global
int x=1000;

int main(void){
    int x=0;//variable local a main
    int r1,r2,c1,c2;
    char c;
    marco1();//llamada a la funcion marco1
    gotoxy(10, 10);
    cout<<"El valor de x en main es: "<<x;
    marco2('*',60,2,70,5);//llamada a la funcion marco2
    marco2('@',10,15,60,17);//llamada a la funcion marco2
    gotoxy(1,20);
    system("pause");
    system("cls");
    ...
    cin>>r2;
    marco2(c,c1,r1,c2,r2);//llamada a la funcion marco2 con parametros capturados
    gotoxy(1,26);
    return 0;
}
